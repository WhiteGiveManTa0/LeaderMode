...
PLATFORM_INTERFACE void CatchAndWriteMiniDump( FnWMain pfn, int argc, char *argv[] );
PLATFORM_INTERFACE void CatchAndWriteMiniDumpForVoidPtrFn( FnVoidPtrFn pfn, void *pv );
