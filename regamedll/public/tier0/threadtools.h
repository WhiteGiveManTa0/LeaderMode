//========== Copyright R 2005, Valve Corporation, All rights reserved. ========
//
...
inline void ThreadSleep(unsigned duration = 0)
{
#ifdef _WIN32
	Sleep(duration);
#elif _LINUX
...
{
public:
	operator const T() const { return CThreadLocal::Get(); }
	int	operator=( T i ) { CThreadLocal::Set( i ); return i; }

	T operator++()					{ T i = CThreadLocal::Get(); CThreadLocal::Set( ++i ); return i; }
	T operator++(int)				{ T i = CThreadLocal::Get(); CThreadLocal::Set( i + 1 ); return i; }
