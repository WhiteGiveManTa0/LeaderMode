...
private:
	...
	bool			   _firstFocusStatus : 1; // keep track if we've had that first focus or not
	bool				m_bAllowNumericInputOnly : 1;
	bool				m_bAllowNonAsciiCharacters : 1;
	bool				m_bAutoProgressOnHittingCharLimit : 1;
