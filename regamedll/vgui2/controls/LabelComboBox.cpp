...
{
	DECLARE_CLASS_SIMPLE( LabelComboBoxButton, MenuButton );
...
LabelComboBoxButton::LabelComboBoxButton(Button *parent, const char *panelName, const char *text) : MenuButton(parent, panelName, "")
{
	m_pParent = parent;
...
LabelComboBox::LabelComboBox(Panel *parent, const char *panelName) : vgui::Button(parent, panelName, "")
{
	...
	m_pButton = new LabelComboBoxButton(this, NULL, "resource/icon_down");	
...
void LabelComboBox::PerformLayout()
{
	...
	m_pButton->SetBounds( wide - 20, 0, 16, 16 );
